...
num_epochs = 5 #number of runs over all digits. There are 3900 digits (combinations of digits), so if you choose 2, you end up with 2*3900 output images
...
num_pixels_final_x = 300 #width
num_pixels_final_y = 300 #height
...
output_folder = './digitsD_train/' #'./new_digits_yolo/' #end it with /
os.makedirs(output_folder, exist_ok=True)

total_number_of_noise_patches = 6
max_number_of_pixels_in_noise_patches = 40 # 10 for 10 x 10 patches
number_of_pixels_away_from_display = 60

#initialize seed to facilitate reproducing bugs 
random.seed(168) #change it when considering train and test
