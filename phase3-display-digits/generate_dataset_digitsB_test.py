...
should_disturb_box_center = True #translate bounding box with digits display
...
num_pixels_final_x = 112 #width
num_pixels_final_y = 112 #height

random_center_shift = 20 #number of pixels the center of the image will be shifted, from - to +
...
output_folder = './digitsB_test/' #'./new_digits_yolo/' #end it with /
os.makedirs(output_folder, exist_ok=True)

total_number_of_noise_patches = 10
max_number_of_pixels_in_noise_patches = 5 # 10 for 10 x 10 patches
number_of_pixels_away_from_display = 2

#initialize seed to facilitate reproducing bugs 
random.seed(115) #change it when considering train and test
