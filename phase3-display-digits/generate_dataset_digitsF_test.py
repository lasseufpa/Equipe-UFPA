...
num_epochs = 300 #number of runs over all digits. There are 10 digits, so if you choose 2, you end up with 2*10 output images
...
output_folder = './digitsF_test/' #'./new_digits_yolo/' #end it with /
